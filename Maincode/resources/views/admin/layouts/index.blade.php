...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ Auth::guard('admin')->user()->role == 0 ? route('shop.list') : (Auth::guard('admin')->user()->role == 1 ? route('dashboard') : route('rating.list')) }}">
                <div class="sidebar-brand-icon rotate-n-15">
                    <i class="fas fa-laugh-wink"></i>
                </div>
                <div class="sidebar-brand-text mx-3">{{ Auth::guard('admin')->user()->role == 0 ? 'HỆ THỐNG' : (Auth::guard('admin')->user()->role == 1 ? \App\Models\Shop::where('admin_id', Auth::guard('admin')->user()->id)->first()->name : \App\Models\Shop::find(Auth::guard('admin')->user()->shop_id)->name) }}</div>
            </a>
